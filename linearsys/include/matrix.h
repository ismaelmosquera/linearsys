...
/*
* Gets the inverse of a square NxN matrix.
...
/*
* Sets the ith row of the matrix passed as parameter.
* param: m Matrix to set any of its rows.
* param: v Vector to set as a row of the matrix m.
* param: row Matrix row to be set.
*
* returns: Matrix with a new row set or m if the row cannot be set.
*/
Matrix* set_row_matrix(const Matrix* m, const Vector* v, int row);

/*
* Sets the jth column of the matrix passed as parameter.
* param: m Matrix to set any of its columns.
* param: v Vector to set as a column of the matrix m.
* param: column Matrix column to be set.
*
* returns: Matrix with a new column set or m if the column cannot be set.
*/
...
*
* returns: pseudoinverse of the matrix passed as parameter.
*/
...
*
* returns: the nearest orthogonal matrix of the matrix passed as parameter, or NULL if the parameter is NULL.
*
*/
...
* The forbinius norm can be useful to know how close is the nearest orthogonal matrix O respect to a matrix M.
* as forbinius norm O - M.
* where O is the nearest orthogonal matrix of M.
* param: m -> matrix to compute its forbinius norm.
*

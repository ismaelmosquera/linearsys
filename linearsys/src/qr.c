...
for(j = n-1; j > i; j--)
{
	/* if position to find a zero is already zero, do nothing and continue */
	if(get_matrix(r, j, i) == 0.0) continue;
/* build rotation matrix to find zeros */
